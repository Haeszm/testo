...
function luatele.VERSION()
  print(luatele_function.colors('%{green}\27[5m'..luatele.logo..'\n'..luatele_function.base64_decode('dGhpcyBmaWxlcyB3YXMgd3JpdHRlbiBieSBATV9QX0xfNiAmIEBRX29fbGw')))
  return true
end
...
function luatele.login(state)
  ...
  elseif state.authorization_state and state.authorization_state.luatele == 'authorizationStateReady' then
    print(luatele_function.colors("%{yellow}VGhlIGZpbGVzIGhhdmUgYmVlbiBjb25uZWN0ZWQgYW5kIHBsYXllZCBcbkRldmVsb3BlciA6IEBNYWhtb3VkTTIgJiBATV9QX0xfNg"))
